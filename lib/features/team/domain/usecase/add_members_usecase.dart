...
class AddMembersUsecase extends Usecase<
    Future<Either<Failure, AddMembersResponseModel>>, AddMemberParams> {
  final TeamRepo teamRepo;

  AddMembersUsecase({required this.teamRepo});

  @override
  Future<Either<Failure, AddMembersResponseModel>> call(AddMemberParams param) {
