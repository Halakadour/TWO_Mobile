...
class CustomAlterDialog extends StatelessWidget {
            ...
            title: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Customchangecontainer(text: 'Very-High'),
                    Customchangecontainer(text: 'High'),
                    Customchangecontainer(text: 'Medium'),
                    Customchangecontainer(text: 'Low'),
                  ],
                ),
                SizedBox(
                  height: 30,
  ...
  const CustomAlterDialog({super.key});
